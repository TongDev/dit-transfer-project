                        ...
                        <div class="dropdown ml-2">
                            <button class="btn btn-info dropdown-toggle" type="button" id="dropdown-menu" data-toggle="dropdown" aria-expanded="false">จัดการข้อมูล</button>
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item disabled" href="school.php">สถาบัน</a></li>
                                    <li><hr class="dropdown-divider"></li>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-2">
                    <a href="school_insert.php" class="btn btn-success mb-3">เพิ่มสถาบัน</a>
                </div>
            </div>
        </div>
        ...
        <table id="course_table" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                    ...
                    $sql = $fetchdata->fetchdata_school();
                    while ($row = mysqli_fetch_array($sql)) {
            
                ?>

                    <tr>
                        <td><?php echo $row['schoolNum']; ?></td>
                        <td><?php echo $row['schoolID']; ?></td>
                        <td><?php echo $row['schoolName']; ?></td>
                        <td><a href="school_update.php?schoolNum=<?php echo $row['schoolNum']; ?>" class="btn btn-warning">แก้ไข</a></td>
                        <td><a href="school_delete.php?del=<?php echo $row['schoolNum']; ?>" class="btn btn-danger">ลบ</a></td>
                    </tr>
