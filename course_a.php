...
<head>
    ...
    <title>จัดการหลักสูตรประกาศนียบัตรชั้นสูง</title>
    <!-- CSS -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container">
        ...
        <h1 class="mt-3">จัดการหลักสูตรประกาศนียบัตรชั้นสูง</h1>
        <hr>
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-3">
                    <a href="course_a_insert.php" class="btn btn-success mb-3">เพิ่มหลักสูตรประกาศนียบัตรชั้นสูง</a> 
                </div>
            </div>
        </div>
        ...
        <table id="course_table" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                    ...
                    $sql = $fetchdata->fetchdata_avp();
                    while ($row = mysqli_fetch_array($sql)) {
            
                ?>

                    <tr>
                        <td><?php echo $row['courseA_ID']; ?></td>
                        <td><?php echo $row['courseA_CodeName']; ?></td>
                        <td><?php echo $row['courseA_Name']; ?></td>
                        <td><?php echo $row['schoolName']; ?></td>
                        <td><?php echo $row['branchA_Name']; ?></td>
                        <td><?php echo $row['courseA_Improve']; ?></td>
                        <td><?php echo $row['courseA_Credit']; ?></td>
                        <td><a href="course_a_update.php?cA_ID=<?php echo $row['courseA_ID']; ?>" class="btn btn-warning">แก้ไข</a></td>
                        <td><a href="course_a_delete.php?del=<?php echo $row['courseA_ID']; ?>" class="btn btn-danger">ลบ</a></td>
                    </tr>
