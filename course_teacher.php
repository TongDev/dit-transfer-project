...
<head>
    ...
    <title>อาจารย์ประจำหลักสูตร</title>
    <!-- CSS -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                        ...
                        <div class="dropdown ml-2">
                            <button class="btn btn-info dropdown-toggle" type="button" id="dropdown-menu" data-toggle="dropdown" aria-expanded="false">จัดการข้อมูล</button>
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a class="dropdown-item disabled" href="course_a.php">หลักสูตร ปวส.</a></li>
                                    ...
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item disabled" href="course_teacher.php">อาจารย์ประจำหลักสูตร</a></li>
    ...
    <div class="container">
        ...
        <h1 class="mt-3">อาจารย์ประจำหลักสูตร</h1>
        <hr>
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-3">
                <a href="teacher_insert.php" class="btn btn-success mb-3">เพิ่มอาจารย์ประจำหลักสูตร</a>
                </div>
            </div>
        </div>
        ...
        <table id="course_table" class="table table-bordered table-striped">
            <thead>
                <th>#</th>
                <th>ชื่ออาจารย์ประจำหลักสูตร</th>
                <th>Username</th>
                <th>Tel.</th>
                <th>แก้ไข</th>
                <th>ลบ</th>
            ...
            <tbody>
                <?php
                    ...
                    $sql = $fetchdata->fetchdata_ctc();
                    while ($row = mysqli_fetch_array($sql)) {
            
                ?>

                    <tr>
                        <td><?php echo $row['ctcID']; ?></td>
                        <td><?php echo $row['ctcName']; ?></td>
                        <td><?php echo $row['ctcUserName']; ?></td>
                        <td><?php echo $row['ctcTel']; ?></td>
                        <td><a href="teacher_update.php?ctcID=<?php echo $row['ctcID']; ?>" class="btn btn-warning">แก้ไข</a></td>
                        <td><a href="teacher_delete.php?del=<?php echo $row['ctcID']; ?>" class="btn btn-danger">ลบ</a></td>
                    </tr>
