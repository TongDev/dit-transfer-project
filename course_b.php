...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="navbar-brand" href="#">Digital Technology</a>
                        ...
                        <div class="dropdown ml-2">
                            <button class="btn btn-info dropdown-toggle" type="button" id="dropdown-menu" data-toggle="dropdown" aria-expanded="false">จัดการข้อมูล</button>
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a class="dropdown-item disabled" href="course_b.php">หลักสูตรปริญญาตรี</a>
                                    </li>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-2">
                    <a href="course_b_insert.php" class="btn btn-success mb-3">เพิ่มหลักสูตรปริญญาตรี</a> 
                </div>
            </div>
        </div>
        <!--<a href="course_b_insert.php" class="btn btn-success mb-3">เพิ่มหลักสูตรปริญญาตรี</a>-->
