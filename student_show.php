...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container">
        ...
        <h1 class="mt-3">จัดการนักศึกษา</h1>
        <hr>
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-2">
                    <a href="student_insert.php" class="btn btn-success mb-3">เพิ่มนักศึกษา</a>
                </div>
            </div>
        </div>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href="student_transfer.php?student_id=<?php echo $row['transcript_ID']; ?>" class="btn btn-success ">เทียบโอน</a></td>
                        <td><a href="student_update.php?student_id=<?php echo $row['transcript_ID']; ?>" class="btn btn-warning ">แก้ไข</a></td>
                        <td><a href="student_delete.php?del=<?php echo $row['transcript_ID']; ?>" class="btn btn-danger ">ลบ</a></td>
                    </tr>
